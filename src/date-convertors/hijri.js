...
function fromGregorian (pYear, pMonth, pDay) {
  ...
  var day = pDay
  var month = pMonth - 1 // Here we enter the Index of the month (which starts with Zero)
  var year = pYear
  ...
  var a = mfloor(y / 100.0)
  var jgc = a - mfloor(a / 4.0) - 2
